...
@interface JSPhotoScrollView()<UIScrollViewDelegate>
...
@implementation JSPhotoScrollView
...
- (void)setIndex:(NSUInteger)index {
    ...
    _index = index;
    UIImage *image = [[JSPhotoTool sharedInstance] GetPhotoWithIndex:index];
    [self displayImage:image];
}

+ (NSUInteger)imageCount {
    
    return [[JSPhotoTool sharedInstance] PhotoCount];
}
